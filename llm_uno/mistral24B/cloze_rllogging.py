...
llm_agent = LLMUnoAgent(env.num_actions, model_id="mistralai/Mistral-Small-24B-Instruct-2501")
random_agent = RandomAgent(env.num_actions)

# Set the agents correctly
#env.set_agents([cfr_agent, cfr_agent, llm_agent])

env.set_agents([cfr_agent, llm_agent])
...
base_filename = "mistral24B_cloze"
file_extension = ".csv"
